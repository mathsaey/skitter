...
defmodule Skitter.RemoteTest do
  ...
  use Skitter.Remote.Test.Case,
    mode: :test_mode,
    handlers: [test_mode: AcceptHandler],
    start_on_remote: [
      mode: :test_mode,
      handlers: [test_mode: AcceptHandler]
    ]
  ...
  describe "errors" do
    ...
    @tag remote: [remote: [start_on_remote: false]]
    ...
    @tag remote: [remote: [start_on_remote: [mode: :test_mode, handlers: []]]]
    ...
    @tag remote: [
           remote: [start_on_remote: [mode: :test_mode, handlers: [test_mode: RejectHandler]]]
         ]
