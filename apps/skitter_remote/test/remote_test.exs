...
defmodule Skitter.RemoteTest do
  ...
  alias Skitter.Remote.Test.{AcceptHandler, RejectHandler}
  use Skitter.Remote.Test.Case, mode: :test_mode, handlers: [test_mode: AcceptHandler]
  ...
  describe "errors" do
    ...
    @tag remote: [remote: [{Application, :stop, [:skitter_remote]}]]
    ...
    @tag remote: [remote: {[], handlers: [test_mode: RejectHandler]}]
  ...
  describe "remote code execution" do
    ...
    @tag remote: [remote1: [], remote2: [], remote3: []]
