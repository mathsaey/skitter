...
defmodule Skitter.DSL.UtilsTest.Helpers do
  def var() do
  ...
  defmacro make_mutable_with_initial_value(do: body) do
    body = Skitter.DSL.Utils.make_mutable_in_block(body, var())
...
defmodule Skitter.DSL.UtilsTest do
  use ExUnit.Case, async: true
  import Skitter.DSL.Utils

  describe "mutable block" do
